...
class GameStats:
    ...
    def write_csv_compare_agents(self, agent):
        file_exists = os.path.isfile("exp_results_compare_agents.csv")
        with open('exp_results_compare_agents.csv', 'a+', newline='') as csv_file:
            fieldnames = ['Agent',
                          'Grid Size',
                          'Number of Colors',
                          'Total score per Game Setting']
...
class Game:
    ...
    def __distribute_new_tiles(self):
        # function for distributing new tiles in the empty spaces
